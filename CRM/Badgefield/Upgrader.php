 ...
 */
class CRM_Badgefield_Upgrader extends CRM_Badgefield_Upgrader_Base {
  ...
  public function install() {
    ...
    $customGroup = civicrm_api3('custom_group', 'create', array(
      'title' => ts('Badge Field', array('domain' => 'org.nesea.badgefield')),
      'name' => 'badge_field',
      'extends' => 'Participant',
  ...
  public function uninstall() {
    ...
    $del = civicrm_api3('CustomField', 'delete', [
      'id' => $result['id'],
    ]);
    ...
    $del = civicrm_api3('CustomGroup', 'delete', [
      'id' => $result['id'],
    ]);
  }
